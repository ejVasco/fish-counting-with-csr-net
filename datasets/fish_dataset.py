...
class FishDataset(
    Dataset
):  # custom dataset inherited from base "Dataset" from torch.utils
    ...
    def __getitem__(self, index):
        ...
        )  # converts from ints to floats (0-255)->(0.0-1.0)
        ...
        density = torch.from_numpy(density).unsqueeze(
            0
        )  # add a channel dimension (reuired by cnn)
